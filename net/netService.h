...
namespace MLN
{
	namespace Net
	{
		...
		public:
			...
			using AcceptorPtrType = boost::shared_ptr<NetServiceAcceptor>;
			using AcceptorContainerType = std::vector< AcceptorPtrType >;

			using ConnectorPtrType = boost::shared_ptr<NetServiceConnector>;
		...
		public:
			...
			static boost::shared_ptr<NetServiceAcceptor> createAcceptor(const size_t acceptorIdx
				, ServiceParams &svcParams
				, AcceptorUserParams &userParams);

			static boost::shared_ptr<NetServiceAcceptor> getAcceptor(const size_t acceptorIdx);


			/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			// connector's interface
			static boost::shared_ptr<NetServiceConnector> createConnector(const size_t connectorIdx
				, ServiceParams &svcParams
				, ConnectorUserParams &userParams);

			static boost::shared_ptr<NetServiceConnector> getConnector(const size_t connectorIdx);
