...
namespace MLN
{
	namespace Net
	{
		...
		boost::shared_ptr<NetServiceAcceptor> NetService::createAcceptor(const size_t acceptorIdx
			...
			, AcceptorUserParams &userParams)
		{
			...
			{
				s_acceptors[acceptorIdx] = boost::make_shared<NetServiceAcceptor>(svcParams);
		...
		boost::shared_ptr<NetServiceAcceptor> NetService::getAcceptor(const size_t acceptorIdx)
		{
		...
		boost::shared_ptr<NetServiceConnector> NetService::createConnector(const size_t connectorIdx
			, ServiceParams &svcParams
			, ConnectorUserParams &userParams)
		{
			...
			{
				s_connectors[connectorIdx] = boost::make_shared<NetServiceConnector>(svcParams, userParams);
		...
		boost::shared_ptr<NetServiceConnector> NetService::getConnector(const size_t connectorIdx)
		{
